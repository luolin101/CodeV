...
if __name__ == '__main__':
    ...
    add_all_steps_with_analysis("Visual SWE-bench/multi_data_onlyvideo.json.json",f"{in_folder}/step1.json",f"{in_folder}/step2_des.json",f"{in_folder}/step2_analysis.json",f"{in_folder}/step3.json")
